(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@nicky-lenaers/ngx-scroll-to', ['exports', '@angular/common', 'rxjs', '@angular/core'], factory) :
    (factory((global['nicky-lenaers'] = global['nicky-lenaers'] || {}, global['nicky-lenaers']['ngx-scroll-to'] = {}),global.ng.common,global.rxjs,global.ng.core));
    ...
    ***************************************************************************** */
     ...
     */ ScrollToAnimation = /** @class */ (function () {
        ...
        function ScrollToAnimation(_container, _listenerTarget, _isWindow, _to, _options, _isBrowser) {
            ...
            this._source$ = new rxjs.ReplaySubject();
        }
        /**
